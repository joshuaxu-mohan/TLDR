"""
Business Breakdowns — thin wrapper around the shared Colossus scraper.

last_verified: 2026-03-23

The normalised source name 'business_breakdowns' maps to this module.
...
_SERIES_SLUG = "business-breakdowns"
